...
@Component({
  selector: 'ngx-trang-thai-cham-soc-1',
  templateUrl: './trang-thai-cham-soc-1.component.html',
  styleUrls: ['./trang-thai-cham-soc-1.component.scss']
})
export class TrangThaiChamSoc1Component
