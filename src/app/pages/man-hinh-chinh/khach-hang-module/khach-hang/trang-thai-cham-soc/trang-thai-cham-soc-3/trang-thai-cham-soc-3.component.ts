...
@Component({
  selector: 'ngx-trang-thai-cham-soc-3',
  templateUrl: './trang-thai-cham-soc-3.component.html',
  styleUrls: ['./trang-thai-cham-soc-3.component.scss']
})
export class TrangThaiChamSoc3Component 
